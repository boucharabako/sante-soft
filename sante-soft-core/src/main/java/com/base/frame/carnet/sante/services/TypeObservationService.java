...
public class TypeObservationService {
    ...
    /**
     * Récupère un type d'observation par son ID
     * @param id ID du type d'observation
     * @return Type d'observation trouvé
     */
    public Optional<TypeObservation> findById(String id) {
        return typeObservationRepository.findById(id);
    }
}
