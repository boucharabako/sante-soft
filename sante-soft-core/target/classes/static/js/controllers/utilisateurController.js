...
//                                alert("alert");
        ...
        $scope.modeEdition = 0;
        $scope.boutonSelect1 = "done";
        $scope.boutonSelect2 = "done";
        $scope.boutonSelect3 = "done";
        $scope.boutonSelect4 = "done last";
        $scope.choix = function (choix) {
//            alert(choix);
            if (choix === 1) {
            ...
            if (choix === 2) {
                $scope.boutonSelect1 = "first done";
                $scope.boutonSelect2 = "current";
                $scope.boutonSelect3 = "done";
                $scope.boutonSelect4 = "last done";
            }
            if (choix === 3) {
             ...
             if (choix === 4) {
                ...
                $scope.boutonSelect2 = "done";
                $scope.boutonSelect3 = "done";
                $scope.boutonSelect4 = "last current";
            }
            ...
            GenericService.get(listeProfilsURL)
                    .then(
                            function (data) {
                                ...
                                jslog("Liste profil"+angular.toJson($scope.listeDesProfils));
                            },
                            function () {
                            }
                    );
